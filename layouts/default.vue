        ...
        >
          ...
          >
            <div v-if="true">
              ...
              <div class="flex items-ceter gap-1 px-3 mb-3">
                <NuxtLink
                  to="/auth"
    ...
    <div id="MainHeader" class="flex items-center w-full bg-white">
      ...
      >
        ...
        <div class="max-w-[700px] w-full md:block hidden">
          <div class="relative">
            <div
              class="flex items-center border-2 border-[#ff4646] w-full rounded-md"
            >
              <input
                type="text"
                class="w-full placeholder-gray-400 text-sm pl-2 focus:outline-none rounded-md"
